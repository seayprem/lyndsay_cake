...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 21, 2022 at 11:06 AM
...
CREATE TABLE `order_head` (
  ...
  `o_special` text COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `order_head` (`o_id`, `o_dttm`, `o_name`, `o_email`, `o_phone`, `o_lineid`, `o_datemeet`, `o_prove`, `o_special`, `o_status`, `o_qty`, `o_total`, `user_id`) VALUES
(1, '2022-10-21 05:06:48', 'วรภาณี บลาๆ', 'tey.woraphanee@gmail.com', '0123456789', 'woraphanee', '2022-10-23', 'product221021050648514946284.png', '', 1, 1, 400, 1),
(2, '2022-10-21 06:24:29', 'วรภาณี บลาๆ', 'tey.woraphanee@gmail.com', '0123456789', 'woraphanee', '2022-10-23', 'product221021062429880062220.jpg', 'หน้าเค้ก', 0, 2, 800, 1),
(3, '2022-10-21 06:25:10', 'วรภาณี บลาๆ', 'tey.woraphanee@gmail.com', '0123456789', 'woraphanee', '2022-10-22', 'product221021062510925987953.jpg', 'ฟไกฟไกฟไกฟไก', 0, 2, 800, 1);
